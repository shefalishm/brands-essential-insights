...
export default async function ArticlePage({ params }: Props) {
  ...
  return <article>
    ...
    <div className="shell prose-wrap"><aside><span>In this insight</span><p>{article.eyebrow || "Practical thinking for modern teams."}</p><a href={`${site.wixUrl}/contact`}>Plan your website ↗</a></aside><div className="prose"><MDXRemote source={article.body} />
